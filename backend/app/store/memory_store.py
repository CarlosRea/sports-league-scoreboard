...
class MemoryStore:
    ...
    def reset_data(self):
        ...
        # Seed Teams
        initial_teams = [
            Team(id="team-riverside", leagueId=league_id, name="Riverside FC", shortName="RFC", logoColor="#10b981", createdAt="2026-08-01T01:00:00.000Z"),
            Team(id="team-apex", leagueId=league_id, name="Apex United", shortName="APX", logoColor="#0284c7", createdAt="2026-08-01T01:05:00.000Z"),
            Team(id="team-redstar", leagueId=league_id, name="Red Star Athletic", shortName="RSA", logoColor="#ef4444", createdAt="2026-08-01T01:10:00.000Z"),
            Team(id="team-oakwood", leagueId=league_id, name="Oakwood Rovers", shortName="OAK", logoColor="#f59e0b", createdAt="2026-08-01T01:15:00.000Z"),
            Team(id="team-harbor", leagueId=league_id, name="Harbor City SC", shortName="HBC", logoColor="#6366f1", createdAt="2026-08-01T01:20:00.000Z"),
            Team(id="team-knights", leagueId=league_id, name="Northern Knights", shortName="NOK", logoColor="#a855f7", createdAt="2026-08-01T01:25:00.000Z"),
        ]
        ...
        initial_matches = [
            # Round 1
            Match(
                id="match-101", leagueId=league_id, homeTeamId="team-riverside", awayTeamId="team-oakwood",
                matchday=1, scheduledAt="2026-09-01T14:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=3, awayScore=1, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-01T14:00:00.000Z", finishedAt="2026-09-01T15:50:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-01T15:50:00.000Z"
            ),
            Match(
                id="match-102", leagueId=league_id, homeTeamId="team-apex", awayTeamId="team-harbor",
                matchday=1, scheduledAt="2026-09-01T16:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=2, awayScore=2, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-01T16:00:00.000Z", finishedAt="2026-09-01T17:55:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-01T17:55:00.000Z"
            ),
            Match(
                id="match-103", leagueId=league_id, homeTeamId="team-redstar", awayTeamId="team-knights",
                matchday=1, scheduledAt="2026-09-02T15:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=1, awayScore=0, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-02T15:00:00.000Z", finishedAt="2026-09-02T16:50:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-02T16:50:00.000Z"
            ),
            # Round 2
            Match(
                id="match-201", leagueId=league_id, homeTeamId="team-oakwood", awayTeamId="team-apex",
                matchday=2, scheduledAt="2026-09-08T14:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=2, awayScore=1, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-08T14:00:00.000Z", finishedAt="2026-09-08T15:52:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-08T15:52:00.000Z"
            ),
            Match(
                id="match-202", leagueId=league_id, homeTeamId="team-knights", awayTeamId="team-riverside",
                matchday=2, scheduledAt="2026-09-08T16:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=1, awayScore=4, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-08T16:00:00.000Z", finishedAt="2026-09-08T17:50:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-08T17:50:00.000Z"
            ),
            Match(
                id="match-203", leagueId=league_id, homeTeamId="team-harbor", awayTeamId="team-redstar",
                matchday=2, scheduledAt="2026-09-09T15:00:00.000Z", status=MatchStatus.FINISHED,
                homeScore=0, awayScore=0, currentPeriod=MatchPeriod.FULL_TIME, elapsedMinutes=90,
                startedAt="2026-09-09T15:00:00.000Z", finishedAt="2026-09-09T16:48:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-09T16:48:00.000Z"
            ),
            # Round 3 (Live In Progress)
            Match(
                id="match-301", leagueId=league_id, homeTeamId="team-riverside", awayTeamId="team-redstar",
                matchday=3, scheduledAt="2026-09-14T18:00:00.000Z", status=MatchStatus.IN_PROGRESS,
                homeScore=2, awayScore=1, currentPeriod=MatchPeriod.SECOND_HALF, elapsedMinutes=68,
                startedAt="2026-09-14T18:00:00.000Z",
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-09-14T19:20:00.000Z",
                events=[
                    MatchEvent(id="ev-1", matchId="match-301", type=MatchEventType.GOAL_HOME, minute=18, homeScoreAfter=1, awayScoreAfter=0, note="Goal scored by Riverside FC", recordedAt="2026-09-14T18:18:00.000Z"),
                    MatchEvent(id="ev-2", matchId="match-301", type=MatchEventType.GOAL_AWAY, minute=34, homeScoreAfter=1, awayScoreAfter=1, note="Equalizer by Red Star Athletic", recordedAt="2026-09-14T18:34:00.000Z"),
                    MatchEvent(id="ev-3", matchId="match-301", type=MatchEventType.GOAL_HOME, minute=57, homeScoreAfter=2, awayScoreAfter=1, note="Go-ahead goal by Riverside FC", recordedAt="2026-09-14T19:12:00.000Z"),
                ]
            ),
            # Round 3 (Scheduled)
            Match(
                id="match-302", leagueId=league_id, homeTeamId="team-apex", awayTeamId="team-knights",
                matchday=3, scheduledAt="2026-09-14T20:00:00.000Z", status=MatchStatus.SCHEDULED,
                homeScore=0, awayScore=0, currentPeriod=MatchPeriod.NOT_STARTED,
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-08-15T10:00:00.000Z"
            ),
            Match(
                id="match-303", leagueId=league_id, homeTeamId="team-oakwood", awayTeamId="team-harbor",
                matchday=3, scheduledAt="2026-09-15T15:00:00.000Z", status=MatchStatus.SCHEDULED,
                homeScore=0, awayScore=0, currentPeriod=MatchPeriod.NOT_STARTED,
                createdAt="2026-08-15T10:00:00.000Z", updatedAt="2026-08-15T10:00:00.000Z"
            ),
        ]
    ...
    # --- Matches ---
    def get_matches(self, league_id: str, status: Optional[str] = None, matchday: Optional[int] = None) -> List[Match]:
